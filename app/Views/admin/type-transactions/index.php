...
<body>
    ...
    <div class="grid">
        <section class="card">
            <h2><?= $current ? 'Modifier' : 'Créer' ?> un type de transaction</h2>
            ...
            <form method="post" action="<?= site_url('admin/type-transactions/save') ?>">
                ...
                <input id="libelle" name="libelle" value="<?= esc($current['libelle'] ?? old('libelle') ?? '') ?>" placeholder="Retrait" required>
                ...
                <tbody>
                    <?php foreach ($items as $item): ?>
                        <tr>
                            ...
                            <td class="actions">
                                <a class="btn" href="<?= site_url('admin/type-transactions?edit=' . $item['id']) ?>">Modifier</a>
