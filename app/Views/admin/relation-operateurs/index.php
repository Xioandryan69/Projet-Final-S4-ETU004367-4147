...
<body>
    ...
    <div class="grid">
        <section class="card">
            <h2><?= $current ? 'Modifier' : 'Créer' ?> une relation opérateur</h2>
            ...
            <form method="post" action="<?= site_url('admin/relation-operateurs/save') ?>">
                ...
                <input id="libelle" name="libelle" value="<?= esc($current['libelle'] ?? old('libelle') ?? '') ?>" placeholder="Meme operateur" required>
                ...
                <tbody>
                    <?php foreach ($items as $item): ?>
                        <tr>
                            ...
                            <td class="actions">
                                <a class="btn" href="<?= site_url('admin/relation-operateurs?edit=' . $item['id']) ?>">Modifier</a>
