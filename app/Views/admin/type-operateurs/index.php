...
<body class="bg-light">
    ...
    <?= view('layouts/header', ['role' => 'admin', 'active' => 'operateurs']) ?>
        ...
        <div class="row g-4">
            <div class="col-lg-5">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        <h2 class="h5 mb-3"><?= $current ? 'Modifier' : 'Créer' ?> un type d’opérateur</h2>
                        ...
                        <form method="post" action="<?= site_url('admin/type-operateurs/save') ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="libelle" name="libelle" class="form-control" value="<?= esc($current['libelle'] ?? old('libelle') ?? '') ?>" placeholder="033" required>
                            </div>
                                    ...
                                    <?php foreach ($items as $item): ?>
                                        <tr>
                                            ...
                                            <td class="d-flex gap-2">
                                                <a class="btn btn-sm btn-dark" href="<?= site_url('admin/type-operateurs?edit=' . $item['id']) ?>">Modifier</a>
